...
/**
 * Event thrown immediately after an explosive impact occurs
 * and right before the damage values are applied to the player.
 * 
...
public class ExplosiveDamageEvent extends Event implements Cancellable {
	...
	public ExplosiveDamageEvent(Player player, double explosionDamage, double impactDamage, ExplosiveImpactEvent origin) {
		this.player = player;
	...
	/**
	 * Get the player involved in the collision. This player is the target of the damage.
	 * 
	...
	/**
	 * Get the damage value caused by the explosion following the collision <strong>only</strong>.
	 * 
	 ...
	 * 
	 * @param explosionDamage The new damage value caused by the explosion.
	 * 
	 * @since 0.10.0
	 */
	 ...
	 * 
	 * @param impactDamage The new damage value of the impact.
	 * 
	 * @since 0.10.0
	 */
	 ...
	 * cancelled, the damage will not be applied to the player.
	 * 
